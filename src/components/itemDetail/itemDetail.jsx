...
const ItemDetail = ({ product }) => {
    ...
    return (
        <div className="contenedor-detalles" >
            <img className="imagen-detalles" src={product.image} alt={product.title} />
            <div className="info-detalles">
                ...
                <div className="botones">                    
                    <button onClick={() => itemsCantidad === 0 ? Swal.fire({
                        title: 'Selecciona una cantidad!',
                        text: 'No puedes comprar 0 de este item',
                        icon: 'error',
                        confirmButtonText: 'Ok'
                    }) : onAdd(product)} className="btn-agregar">Agregar al carrito</button>

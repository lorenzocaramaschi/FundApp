          ...
          >
            <ul className="navbar-nav alinear-items">
              ...
              <li className="nav-item dropdown">
                ...
                >
                  <li>
                    <Link to={"/categoria/dibujadas"} className="dropdown-item">
                      Dibujadas
                    </Link>
                  </li>
                  <li>
                    <Link to={"/categoria/solidas"} className="dropdown-item">
                      Solidas
                    </Link>
                  </li>
                  <li>
                    <Link to={"/categoria/tematicas"} className="dropdown-item">
                      Tematicas
                    </Link>
                  </li>
                </ul>
              ...
              <li className="nav-item">
                <Link to={"/contactos"} className="nav-link active">
                  Contactos
                </Link>
              </li>
              <CartWidget />
